...
|---|---|---|---|
| `tests` | PASS | 1432 passed | `python3 -m pytest -q` |
...
| `capability_matrix` | PASS | 27 proven, 148 missing, 9 partial -- re-derives identically | `python3 tools/capability_matrix.py --out program/v3_3/VERIHARNESS_CAPABILITY_MATRIX.json` |
